...
async function setOwnerNumberCommand(sock, chatId, message, args) {
    try {
        ...
        if (!args || args.length === 0) {
            ...
            await sock.sendMessage(chatId, { 
                text: `📞 Current Owner Number: ${current}\n\nUsage: .setownernumber <2349070810971>\nExample: .setownernumber 2349165904969\n\n⚠️ Bot will auto-restart after update.` 
            }, { quoted: message });
            return;
        }
        ...
        if (newNumber.length === 0) {
            await sock.sendMessage(chatId, { 
                text: '❌ Please enter a valid phone number.\nExample: .setownernumber 2349070810971' 
            }, { quoted: message });
            return;
        }
...
async function configHelpCommand(sock, chatId, message) {
    try {
        ...
        const helpText = `*🔧 CK SHADOW-MD CONFIGURATION COMMANDS*
