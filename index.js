...
//════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════//
//* 
//  * project_name : CK SHADOW-MD
//  * author : CK shadow
//  * youtube : https://youtube.com/@charley010?si=Pn4ECoC7vd2v2Voq
//  * description : CK SHADOW-MD ,A Multi-Device whatsapp user bot.
//*
//*
//re-upload? recode? copy code? give credit to CK SHADOW 2025:)
//Instagram: shadow
//Telegram: t.me/Darkwebtoolsv15
//GitHub: Ebukannalue1132
//WhatsApp: +2349070810971
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@charley010?si=Pn4ECoC7vd2v2Voq
//   * Created By Github: Ebukannalue1132.
//   * Credit To CK shadow tech
//   * © 2026 CK SHADOW-MD.
// ⛥┌┤
// */ 
...
let phoneNumber = "2349070810971"
let owner = JSON.parse(fs.readFileSync('./data/owner.json'))

global.botname = "CK SHADOW-MD"
global.themeemoji = "🤖"
...
// Message handling
                    ...
                    await XeonBotInc.sendMessage(mek.key.remoteJid, {
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                ...
                                newsletterName: 'CK SHADOW-MD BOTS',
                                serverMessageId: -1
                            }
                        }
                    }).catch(console.error);
    ...
    if (pairingCode && !XeonBotInc.authState.creds.registered) {
        ...
        if (!!global.phoneNumber) {
            ...
            phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 2349070810971 (without + or spaces) : `)))
        }
        ...
        if (!pn('+' + phoneNumber).isValid()) {
            console.log(chalk.red('Invalid phone number. Please enter your full international number (e.g., 16543897634 for US, 448756980975 for UK, 2349070810971 for Nigeria etc.) without + or spaces.'));
            process.exit(1);
        }
...
*🛠️ CK SHADOW-MD - Professional WhatsApp Bot*`,
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'CK SHADOW-MD'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: CK SHADOW TECH`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: Ebukannalue1132`))
