...
const { setBotNameCommand, setBotOwnerCommand, setOwnerNumberCommand,setYTChannelCommand,setPackNameCommand,setAuthorCommand, setTimezoneCommand,configHelpCommand } = require('./commands/Shadow');
...
const tempfileCommand = require('./commands/tempfile');
...
global.channelLink = "https://whatsapp.com/channel/0029Vb7Zrwp3LdQadGiGA92v";
global.ytch = settings.ytChannel || "CK SHADOW TECH";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb7Zrwp3LdQadGiGA92v' 
                }, { quoted: message });
                return;
          ...
          case userMessage === '.botinfo' || userMessage === '.binfo':
                {
                    ...
                    let botInfoText = `🤖 *BOT INFORMATION*\n\n` +
                                    `*Name:* ${settings.botName || 'SHADOW-MD'}\n` +
                    ...
                    botInfoText += `📊 *Statistics:*\n` +
                                 ...
                                 `• YouTube: https://youtube.com/@charly\n` +
